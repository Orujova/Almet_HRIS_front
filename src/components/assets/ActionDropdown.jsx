...
// Action Dropdown Component for Table
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-almet-sapphire/20"
        title="Actions"
      >
        ...
        <>
          ...
          <div className={`absolute right-0 top-full mt-1 w-48 ${bgCard} rounded-lg shadow-xl border ${borderColor} z-50 py-1`}>
            <button
              ...
              className="w-full px-4 py-2 text-left text-xs hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors flex items-center gap-2"
            >
