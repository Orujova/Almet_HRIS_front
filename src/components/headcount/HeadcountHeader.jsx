// src/components/headcount/CleanWorkforceHeader.jsx
...
/**
 * Clean, minimal workforce management header
 * Reduces visual clutter while maintaining all functionality
 */
const CleanWorkforceHeader = ({ 
  // Tab props
  activeTab = 'employees',
  onTabChange,
  ...
  isActionMenuOpen,
  onQuickExport,
  onToggleExportModal, // Modal açmaq üçün
  isExporting = false,
  
  // Import props
  onBulkImport, // Import modal açmaq üçün
    ...
    switch (activeTab) {
      ...
      case 'vacant':
        return {
          ...
          icon: Plus,
          onClick: () => router.push('/structure/vacant-positions/create'),
      ...
      <div className={`${bgCard} rounded-lg border ${borderColor} shadow-sm`}>
        <div className="p-4">
          ...
          <div className="flex items-center justify-between">
            ...
            {/* Tab-specific Actions - Condensed */}
            <div className="flex items-center space-x-2">
              

              {/* Filters */}
              {(activeTab === 'employees' || activeTab === 'vacant') && (
                <button
        ...
        {/* Active Filters/Sorting Indicator - Minimal */}
        {(hasActiveFilters || hasActiveSorting) && activeTab === 'employees' && (
            ...
            <div className="flex items-center justify-between text-sm">
              ...
              <button
                onClick={() => {
                  ...
                  if (hasActiveFilters) onToggleAdvancedFilter();
                  if (hasActiveSorting) onToggleAdvancedSorting();
                }}
...
export default CleanWorkforceHeader;